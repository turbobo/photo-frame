...
import {
  ...
  TITLE_FONT_SCALE, SUBTITLE_FONT_SCALE, PARAM_LABEL_SCALE, PARAM_VALUE_SCALE,
  LENS_TEXT_SCALE, ALPHA_SEMI_TRANSPARENT, ALPHA_WEAK_TEXT, ALPHA_MEDIUM,
  ALPHA_STRONG, BG_MASK_COLOR, LEICA_RED, LOGO_HEIGHT_RATIO,
  LOGO_GAP_RATIO, LOGO_TEXT_GAP_RATIO, IMAGE_CORNER_REDUCTION,
  SEPARATOR_DOT_RADIUS_RATIO, SEPARATOR_DOT_MIN_RADIUS, LEICA_DOT_RADIUS_RATIO,
  LEICA_DOT_OFFSET_X, LEICA_TEXT_OFFSET_X, LINE_GAP_RATIO,
  BLOCK_GAP_RATIO, BLOCK_MIN_GAP_RATIO, RIGHT_AREA_MARGIN_MULTIPLIER,
  VERTICAL_SAFETY_MARGIN, HORIZONTAL_SHRINK_FACTOR, MAX_BG_SIZE,
  BG_JPEG_QUALITY, BG_BLUR_AMOUNT, BG_SATURATE_MULTIPLIER,
  BG_BRIGHTNESS_MULTIPLIER, BG_OPACITY, BG_SCALE, BG_SIZE_PERCENT,
} from '../constants'
